...
namespace CaratManagementReports.SmartReports {
  ...
  [SmartReport(ReportTypeEnum.Table, "List all projects with dupes in HTML table", PageOrientation.Portrait, ReportDestinationEnum.Html)]
  public class ListProjectsWithDupesHtml : SmartReport, IReportPrint, IReportEmail {

    private TCaratProjectCollection Projects;

    public ListProjectsWithDupesHtml(TCaratProjectCollection projects, string title = "")
      : base() {
